    ...
    <section className="py-20 bg-gradient-to-br from-indigo-900 via-indigo-800 to-purple-900 text-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-1/2 right-1/4 w-16 h-16 bg-indigo-400/10 rounded-lg animate-spin" style={{animationDuration: '8s'}}></div>
        </div>
        ...
        <div className="relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-indigo-100 max-w-3xl mx-auto">
              Découvrez comment SENDATAVIZ a transformé les opérations de nos clients 
              avec des solutions BI innovantes et performantes.
            </p>
          </div>
          ...
          <div className="relative max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
                  ...
                  <div className="lg:col-span-2">
                    <div className="relative">
                      ...
                      <blockquote className="text-xl lg:text-2xl font-medium text-white leading-relaxed mb-6 pl-8">
            ...
            <div className="flex items-center justify-between mt-8">
              <Button
                ...
                className="text-white hover:text-emerald-400 hover:bg-white/10 p-3"
              >
