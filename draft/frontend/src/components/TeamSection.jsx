      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            SENDATAVIZ réunit des experts reconnus en Business Intelligence, développement et intégration 
            de systèmes pour vous accompagner dans vos projets les plus ambitieux.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-indigo-50 to-emerald-50 rounded-3xl p-8 lg:p-12">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Ce qui nous guide dans chaque projet et nous permet de livrer 
              des solutions d'exception à nos clients.
            </p>
          </div>
            ...
            {[
              {
                icon: Award,
                title: "Excellence",
                description: "Nous visons l'excellence dans chaque livrable, avec un souci du détail qui fait la différence."
              },
              {
                icon: Users,
                title: "Collaboration",
              ...
              },
              {
                icon: Target,
                title: "Résultats",
                description: "Nous nous concentrons sur des livrables concrets qui génèrent une valeur mesurable pour votre business."
              }
            ].map((value, index) => (
