...
export default function EnhancedHeroSection() {
  ...
  return (
    <section ref={heroRef as any} className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24 md:pt-28 lg:pt-32">
      {/* Background layers */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-5xl mx-auto">
          <div className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-indigo-50 to-emerald-50 border border-indigo-200/50 rounded-full text-indigo-700 text-xs sm:text-sm font-semibold mb-12 sm:mb-8 shadow-lg backdrop-blur-sm animate-fade-in-up mt-24 sm:mt-16 lg:mt-12">
            ...
            <span className="block animate-slide-up-enhanced" style={{ animationDelay: "0.6s" }}>
              en <span className="relative">
                ...
                <svg className="absolute -bottom-2 left-0 w-full h-3" viewBox="0 0 200 12" fill="none">
                  <path d="M2 10C50 2 100 2 150 10C170 12 180 8 198 10" stroke="url(#paint0_linear)" strokeWidth="3" strokeLinecap="round"/>
                  <defs>
          ...
          <p className="text-xl lg:text-2xl text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed animate-fade-in-up font-medium" style={{ animationDelay: "1.2s" }}>
            ...
            révolutionne votre approche de la data avec des solutions BI sur mesure, l'intégration intelligente de systèmes et le développement d'applications métier de nouvelle génération.
          </p>
      ...
      {/* Custom CSS for animations (global) */}
      <style>{`
        ...
        .animate-slide-up-enhanced { animation: slide-up-enhanced 1s ease-out forwards; opacity: 0; }
